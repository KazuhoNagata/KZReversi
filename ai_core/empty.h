...
INT32 SearchEmpty_2(UINT64 bk, UINT64 wh, UINT64 blank,
	INT32 pos1, INT32 pos2, INT32 alpha, INT32 beta, PVLINE *pline);
	INT32 SearchEmpty_3(UINT64 bk, UINT64 wh, UINT64 blank, INT32 empty,
		UINT32 parity, INT32 alpha, INT32 beta, PVLINE *pline);
